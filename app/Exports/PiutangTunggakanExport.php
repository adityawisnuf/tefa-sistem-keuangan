...
class PiutangTunggakanExport implements FromView, ShouldAutoSize, WithStyles, WithTitle
{
    protected $dataSiswa;
    ...
    {
        return view('print.printExcelPiutangTunggakan', ['dataSiswa' => $this->dataSiswa]);
    }
    ...
    public function styles(Worksheet $worksheet)
    {
        ...
        $worksheet->setCellValue('A1', 'Laporan Piutang dan Tunggakan Siswa');
        ...
        $worksheet->getStyle('A2:H' . $worksheet->getHighestRow())->applyFromArray([
            'font' => [
                'size' => 12,
            ],
            'alignment' => [
