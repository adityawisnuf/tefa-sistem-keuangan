...
<head>
    ...
    <title>Laporan Pembayaran Siswa Tahunan</title>
...
<body>
    ...
    <div class="table-container">
        <table>
            ...
            <tbody>
                @foreach ($pembayaranSiswas as $index => $pembayaranSiswa) <!-- Pastikan singular -->
                <tr>
                    <td>{{ $loop->iteration }}</td>
                    <td>{{ $pembayaranSiswa->nama_depan . ' ' . $pembayaranSiswa->nama_belakang }}</td> <!-- Perbaiki nama variabel -->
                    <td>{{ $pembayaranSiswa->kelas->kelas ?? 'Tidak ada data' }}</td>
                    <td>{{ $pembayaranSiswa->kelas->jurusan ?? 'Tidak ada data' }}</td>
                    <td>{{ $pembayaranSiswa->telepon }}</td>
                    <td>{{ $pembayaranSiswa->orangtua->nama ?? 'Tidak ada data' }}</td>
                </tr>
            @endforeach
            </tbody>
        </table>
