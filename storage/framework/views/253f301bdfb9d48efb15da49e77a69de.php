        ...
        <table>
            ...
            <?php $__empty_1 = true; $__currentLoopData = $pembayarans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pembayaran): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr>
                    ...
                    <td><?php echo e(Carbon\Carbon::parse($pembayaran->created_at)->format('d-m-Y')); ?></td>
                </tr>
...
<?php /**PATH D:\PKL\Buku Kas Rekapitulasi\tefa-sistem-keuangan\resources\views/print/pembayaran.blade.php ENDPATH**/ ?>