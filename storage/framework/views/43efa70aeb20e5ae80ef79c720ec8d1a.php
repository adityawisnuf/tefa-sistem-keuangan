...
<body>
    ...
    <div class="table-container">
        <table>
            ...
            <tbody>
                <?php $__currentLoopData = $anggarans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $anggaran): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    <td><?php echo e($loop->iteration); ?></td>
                    <td><?php echo e($anggaran->nama_anggaran); ?></td>
                    <td><?php echo e('Rp ' . number_format($anggaran->nominal, 0, ',', '.')); ?></td>
                    <td><?php echo e($anggaran->tanggal_pengajuan); ?></td>
                    <td><?php echo e($anggaran->target_terealisasikan); ?></td>
                    <td><?php echo e($anggaran->getStatusText()); ?></td>
                    <td><?php echo e($anggaran->pengapprove); ?></td>
                    <td><?php echo e($anggaran->pengapprove_jabatan); ?></td>
                </tr>
...
</html><?php /**PATH D:\PKL\RencanaAnggaran+Monitoring\tefa-sistem-keuangan\resources\views/print/anggaran.blade.php ENDPATH**/ ?>