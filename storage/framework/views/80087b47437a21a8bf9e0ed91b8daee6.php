  ...
  <!-- Garis bawah kop surat -->
    ...
    <div class="table-container">
        <table>
            ...
            <tbody>
                <?php $__currentLoopData = $deviasis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $deviasi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td class="no"><?php echo e($loop->iteration); ?></td>
                        <td><?php echo e($deviasi->nama_anggaran); ?></td>
                        <td>Rp. <?php echo e(number_format($deviasi->nominal, 0)); ?></td>
                        <td>Rp. <?php echo e(number_format($deviasi->nominal_diapprove, 0)); ?></td>
                        <td><?php echo e($deviasi->nominal_diapprove  != 0 ? ($deviasi->nominal_diapprove / $deviasi->nominal) * 100 : '0'); ?>%</td>
                    </tr>
...
</html><?php /**PATH C:\laragon-php-8-mariadb-11\laragon-6.0-portable\www\kelompok-3\tefa-sistem-keuangan\resources\views/Print/Deviasi.blade.php ENDPATH**/ ?>